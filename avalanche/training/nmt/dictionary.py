...
# 2022 Copyright (c) Michele Resta
...
import torch
import temp_data_utils as data_utils
from data_utils import Chunker, find_offsets
...
class Dictionary:
    ...
    def __init__(
        ...
        self.bos, self.unk, self.pad, self.eos = bos, unk, pad, eos
        self.symbols = []
        self.count = []
        self.indices = {}
    ...
    def add_file_to_dictionary(filename, dict, tokenize, num_workers):
        ...
        if num_workers > 1:
            ...
            merge_result(
                Dictionary._add_file_to_dictionary_single_worker(
                    local_file, tokenize, dict.eos, offsets[0], offsets[1]
                )
            )
